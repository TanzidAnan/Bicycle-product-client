            ...
            <div ref={sliderRef} className="keen-slider rounded-md" style={{ height: 600 }}>
                ...
                <div className="keen-slider__slide number-slide5">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="">
                            <div className="">
                                <img className="w-full" src="https://i.ibb.co.com/2Y6sPSm/specialized-turbo-como-5-0-397830-11-removebg-preview-308x230.png" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="keen-slider__slide number-slide6">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="">
                            <div className="">
                                <img className="w-full" src="https://i.ibb.co.com/8Pj9Pcz/cannondale-trail-6-383504-1-removebg-preview-308x230.png" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
